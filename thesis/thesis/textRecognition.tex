...
\caption{KNN algorithm: with $k=3$, the algorithm will assign the new element to class A; with $k=7$ to class B.\xxx{neni to obracene?}} \label{fig:characterClassKNN}
\end{figure}
