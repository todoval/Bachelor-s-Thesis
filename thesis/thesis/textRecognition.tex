...
height=30mm]{img/noise_saltpepper.png}}}\\
...
&
\fbox{\raisebox{-\height}{\includegraphics[width=0.3\textwidth,
height=30mm]{img/noise_gaussian.jpg}}}\\
Other
...
&
\fbox{\raisebox{-\height}{\includegraphics[width=0.3\textwidth,
height=30mm]{img/noise_periodic.jpg}}}\\
\bottomrule
...
\includegraphics[width=\linewidth,height=30mm]{img/feature_zoning.png}
\caption{Zoning} \label{fig:1b}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.30\textwidth}
\includegraphics[width=\linewidth,height=30mm]{img/feature_crossing.png}
\caption{Crossing and distances \citep{crossingAndDistances}} \label{fig:1c}
\end{subfigure}
\begin{subfigure}{0.30\textwidth}
\includegraphics[width=\linewidth,height=30mm]{img/features_geometrical.png}
