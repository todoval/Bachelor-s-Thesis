...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/bin_orig.png}
\caption{Original Image} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/bin_glob.png}
\caption{Global Thresholding} \label{fig:1b}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/bin_sauvola.png}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/deskew_orig.jpg}
\caption{Original image} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/deskew_new.jpg}
...
height=30mm]{img/preprocessing/noise_saltpepper.png}}}\\
...
&
\fbox{\raisebox{-\height}{\includegraphics[width=0.3\textwidth,
height=30mm]{img/preprocessing/noise_gaussian.jpg}}}\\
Other
...
&
\fbox{\raisebox{-\height}{\includegraphics[width=0.3\textwidth,
height=30mm]{img/preprocessing/noise_periodic.jpg}}}\\
\bottomrule
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{img/preprocessing/denoise_orig.png}
\caption{Original Image} \label{fig:1a}
\end{figure}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/denoise_gauss.png}
\caption{Gaussian filter} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/denoise_median.png}
\caption{Median filter} \label{fig:1b}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/preprocessing/denoise_nonlocal.png}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth,height=60mm]{img/preprocessing/scan_borders_orig.png}
\caption{Original Image} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth,height=60mm]{img/preprocessing/scan_borders_result.png}
