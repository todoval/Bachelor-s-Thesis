...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{img/prepocessing/interp_orig.pdf}
...
\includegraphics[width=\linewidth]{img/prepocessing/interp_nn.pdf}
\caption{Nearest-neighbor Interpolation (1 pixel)} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/interp_bili.pdf}
\caption{Bilinear Interpolation($2\times2$ pixels)} \label{fig:1b}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/interp_bicubic.pdf}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/grayscale_orig.jpg}
\caption{Original Image} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/grayscale_avg.png}
\caption{Averaging Technique} \label{fig:1b}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/grayscale_luma.png}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/bin_orig.png}
\caption{Original Image} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/bin_glob.png}
\caption{Global Thresholding} \label{fig:1b}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/bin_sauvola.png}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{imgprepocessing//histogram_low.png}
\caption{Low contrast image histogram} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/histogram_high.png}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/contrast_low.png}
\caption{Before} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/contrast_high.png}
\caption{After}
\end{subfigure}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/deskew_orig.jpg}
\caption{Original image} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/deskew_new.jpg}
...
height=30mm]{img/prepocessing/noise_saltpepper.png}}}\\
...
&
\fbox{\raisebox{-\height}{\includegraphics[width=0.3\textwidth,
height=30mm]{img/prepocessing/noise_gaussian.jpg}}}\\
Other
...
&
\fbox{\raisebox{-\height}{\includegraphics[width=0.3\textwidth,
height=30mm]{img/prepocessing/noise_periodic.jpg}}}\\
\bottomrule
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{img/prepocessing/denoise_orig.png}
\caption{Original Image} \label{fig:1a}
\end{figure}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/denoise_gauss.png}
\caption{Gaussian filter} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/denoise_median.png}
\caption{Median filter} \label{fig:1b}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth]{img/prepocessing/denoise_nonlocal.png}
...
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth,height=60mm]{img/prepocessing/scan_borders_orig.png}
\caption{Original Image} \label{fig:1a}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.31\textwidth}
\includegraphics[width=\linewidth,height=60mm]{img/prepocessing/scan_borders_result.png}
