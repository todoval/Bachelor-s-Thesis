...
\def\Dedication{%
I would like to express my sincere gratitude to Mgr. Miroslav Kratochvíl, the supervisor of this thesis, for his time, guidance and patience over the last year.
...
\def\Keywords{%
{optical character recognition}, {document digitalization}, {table recognition}, {image processing}
}
...
\include{layoutRecognition}
\include{tableRecognitionImpl}
\include{results}
